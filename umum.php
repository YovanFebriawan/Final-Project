...
<head>
	...
	<title>Pepapugo - Dokter Umum</title>
	<style type="text/css">
		body{
...
<body>
	...
	<table class="table table-hover table-bordered" id="umum">
	  ...
	  <tbody>
	  	...
	  	include 'koneksi.php';
	  	$no=1;
	  	$umum = mysqli_query($koneksi, "Select * From dokter_umum order by tanggal_antri");
	  	while($row=mysqli_fetch_array($umum)){
	  	echo "<tr>
	      <td>".$no++."</td>
	      <td>".$row['username']."</td>
