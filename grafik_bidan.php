		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					data: [
					<?php 
					$jumlah_senin = mysqli_query($koneksi,"select * from bidan where hari = 'Senin'");
					echo mysqli_num_rows($jumlah_senin);
					?>,
					<?php 
					$jumlah_selasa = mysqli_query($koneksi,"select * from bidan where hari = 'Selasa'");
					echo mysqli_num_rows($jumlah_selasa);
					?>,
					<?php 
					$jumlah_rabu = mysqli_query($koneksi,"select * from bidan where hari = 'Rabu'");
					echo mysqli_num_rows($jumlah_rabu);
					?>,
					<?php 
					$jumlah_kamis = mysqli_query($koneksi,"select * from bidan where hari = 'Kamis'");
					echo mysqli_num_rows($jumlah_kamis);
					?>,
					<?php 
					$jumlah_jumat = mysqli_query($koneksi,"select * from bidan where hari = 'Jumat'");
					echo mysqli_num_rows($jumlah_jumat);
					?>,
					<?php 
					$jumlah_sabtu = mysqli_query($koneksi,"select * from bidan where hari= 'Sabtu'");
					echo mysqli_num_rows($jumlah_sabtu);
					?>,
					<?php 
					$jumlah_minggu = mysqli_query($koneksi,"select * from bidan where hari = 'Minggu'");
