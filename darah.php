...
<head>
	...
	<title>Pepapugo - Tes Darah</title>
	<style type="text/css">
		body{
...
<body>
	...
	<table class="table table-hover table-bordered" id="umum">
	  ...
	  <tbody>
	  	...
	  	include 'koneksi.php';
	  	$no=1;
	  	$darah = mysqli_query($koneksi, "Select * From tes_darah order by tanggal_antri");
	  	while($row=mysqli_fetch_array($darah)){
	  	echo "<tr>
	      <td>".$no++."</td>
	      <td>".$row['username']."</td>
